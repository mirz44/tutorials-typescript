...
// Unions
let pId: string | number; // Can be assigned values of type "string" and "number"
pId = "mm1";
pId = 11;
...
// Objects
type PersonTypes = {
  // Types can be used with Unions but Interfaces cannot
  id: number;
  name: string;
};
...
class Student implements StudentInterface {
  // Use 'implements' to assign types to the class
  id: number;
  name: string;
...
class Employee extends Student {
  // Class using Student class details
  postion: string;
